...
#define __SaveCursorPositionContext__ position_tp __position_x__ = CURSOR_POSITION_X; \
                                position_tp __position_y__ = CURSOR_POSITION_Y

#define __ApplyCursorPositionContext__ GotoXY(__position_x__, __position_y__)
